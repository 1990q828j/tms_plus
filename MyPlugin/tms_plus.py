...
/***************************************************************************
 MyPlugin
                                 A QGIS plugin
 update gaode street time
                              -------------------
        begin                : 2018-04-16
        git sha              : $Format:%H$
        copyright            : (C) 2018 by jianqing
        email                : tsinggreen@hotmail.com
 ***************************************************************************/
...
from tms_plus_dialog import MyPluginDialog
import os.path
...
class MyPlugin:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'gaode_traffic_predict'),
            callback=self.run,
